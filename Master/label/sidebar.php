    ...
    <li class="nav-item">
      ...
      <div class="collapse" id="cetak">
        <ul class="nav flex-column sub-menu">
          ...
          <li class="nav-item"> <a class="nav-link" href="CetakLabel_purc.php"> Print Label Purchase  </a></li>
          <li class="nav-item"> <a class="nav-link" href="CetakBarcode.php"> Print Barcode </a></li>
          <li class="nav-item"> <a class="nav-link" href="CetakBarcode_purc.php"> Print Barcode Purchase</a></li>
        </ul>
      </div>
    </li>
  </ul>
