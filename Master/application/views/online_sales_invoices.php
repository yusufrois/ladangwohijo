<div class="row">
    <div class="col-md-12 ">
        ...
        <div class="col-md-12">
            <?php $data=array( 'class'=>'btn btn-info btn-outline-primary pull-right','name'=>'searchecord','value'=>'Cari Invoice'); echo form_submit($data); ?>
...
<div class="row">
    <div class="col-md-12 ">
        <h4 class="text-left" style="margin-left:2%;"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Lihat invoices</h4>
    </div>
...
<section style="border-bottom: 2px solid #00c0ef;" class="invoice" id="<?php echo $invoices_record[$i]->id; ?>">
    ...
    <div class="row">
        <div class="col-xs-12">
            ...
            <small class="pull-right">Tanggal: <?php echo $invoices_record[$i]->date; ?></small>
          </h2>
        </div>
    </div>
        ...
        <div class="col-xs-12">
            <h4>
                    ...
                    <?php 
                        ...
                        {
                            echo "Tidak diverifikasi";
                        }
                        else if($invoices_record[$i]->status  == 3)
                        {
                            echo "Diantarkan ke customer";
                        } 
                        else if($invoices_record[$i]->status  == 4)
                        {
                            echo "invoice kadaluarsa";
                        } 
                        else
                        {
                            echo "Error";
    ...
    <div class="row invoice-info">
        <div class="col-sm-4 invoice-col">
            <b>Agen# <?php echo $invoices_record[$i]->agentname; ?></b>
            <br>
            ...
            <div class="row">
                <div class="col-md-12">
                    <address> 
                            Alamat: <?php echo $this->db->get_where('mp_contactabout', array('id' => 1))->result_array()[0]['address'] ;?><br>
                            Telepon: <?php echo $this->db->get_where('mp_contactabout', array('id' => 1))->result_array()[0]['phone_number'] ;?><br>
        ...
        <div class="col-xs-12">
            <div class="table-responsive">
                <table class="table">
                    ...
                    <tr>
                        <th style="width:50%">Biaya Pengiriman(
                            <?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?>):</th>
                        <td class="text-right">
    ...
    <div class="row no-print">
        <div class="col-md-12">
            ...
            { 
            ?>
            <button type="button"  class="btn btn-primary btn-flat  pull-right btn-lg  " onclick="show_modal_page('<?php echo base_url().'orders/popup/add_delivery_model/'.$invoices_record[$i]->id ?>')" > <i class="fa fa-truck" aria-hidden="true"></i>     Dikirimkan ke customer
            </button>
            <button type="button" onclick="show_modal_page('<?php echo base_url().'orders/popup/customer_profile_model/'.$invoices_record[$i]->cus_id ?>')" class="btn btn-default btn-flat  pull-right btn-lg  "> <i class="fa fa-user" aria-hidden="true"></i> Profil Customer 
            </button>
            <button onclick="show_modal_page('<?php echo base_url().'orders/popup/prescription_image_model/'.$invoices_record[$i]->prescription_id ?>')"  name="print_button" class="btn btn-success btn-flat   pull-right btn-lg "><i class="fa fa-eye "></i> Lihat Resep 
            </button>
            <button onclick="printDiv(<?php echo $invoices_record[$i]->id; ?>)" name="print_button" class="btn btn-info btn-flat   pull-right btn-lg "><i class="fa fa-print pull-left"></i> Cetak invoice 
            </button>
            <?php 
            } 
            else 
    ...
    <div class="row ">
        <span><u> Dikirimkan ke </u>  :<i><?php echo $invoices_record[$i]->delivered_to; ?></i></span>,
        <span><u> Dikirimkan oleh </u> : <i><?php echo $invoices_record[$i]->delivered_by; ?></i></span>,
        <span><u> Tanggal Dikirimkan </u>  : <i><?php echo $invoices_record[$i]->delivered_date; ?></i></span>
        <p>
            <br />
            <span><u> Deskripsi </u>  :</span>
