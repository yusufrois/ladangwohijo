                     ...
                     <div class="row">
                         <div class="col-md-12">
                            ...
                            <?php echo form_open_multipart('backup/restore',$attributes); ?>
                                ...
                                <div class="form-group text-center">                  
                                    <?php
                                        $data = array('class'=>'btn btn-default btn-outline-primary ','type' => 'submit','name'=>'btn_submit_Service','value'=>'true', 'content' => '<i class="fa fa-upload" aria-hidden="true"></i> Klik untuk restore database ');
