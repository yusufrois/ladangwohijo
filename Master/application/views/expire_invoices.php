<div class="row">
    <div class="col-md-12 ">
        <h4 class="text-left" style="margin-left:2%;"><i class="fa fa-hand-o-right" aria-hidden="true"></i> Lihat invoice</h4>
    </div>
</div>
    <?php
    ...
    <section class="invoice" id="<?php echo $Sales_Record[$i][0]->id; ?>">
        ...
        <div class="row no-print">
            ...
            <div class="col-md-5">
                <button type="button" class="btn btn-default btn-flat  pull-right margin  " onclick="#"> <i class="fa fa-user" aria-hidden="true"></i> Profil Customer </button>
                <button onclick="show_modal_page('<?php echo base_url().'orders/popup/prescription_image_model_temp/'.$invoices_record[$i]->id ?>')" name="print_button" class="btn btn-success btn-flat   pull-right margin "><i class="fa fa-eye "></i> Lihat Resep </button>
            </div>
        </div>
    </section>
