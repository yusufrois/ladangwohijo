...
<body class="hold-transition login-page " style="background-color: #ADFF2F; position: relative;">
   <br/><br/><br/><br/> <br/>
  <div class="col-md-4 col-md-offset-4" style="background: #7CFC00; padding:10px; border-radius:7px;">
  <br/><br/>   
        <h3 class="text-center" style="font-family: cursive;">
            <a href="<?php echo base_url('login'); ?>"> <b style="color:#faffbd;">Sistem Akuntansi Agro</b></a>
        </h3>
        <div class="text-center">
            <!-- <img src="<?php echo base_url();?>assets/img/gm.png" style="width: 60%;"> -->
             <h1 class="text-center" style="font-family: cursive;">
            <a href="<?php echo base_url('login'); ?>"> <b style="color:#000000;">Master Melon Indonesia</b></a>
        </h1>
        </div>
