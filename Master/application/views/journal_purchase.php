<section class="content">
    <div class="box" id="print-section">
        <div class="box-body ">
            ...
            ?>
            <?php echo form_open('statements/create_journal_purchase',$attributes); ?>
            <div class="">
                <div class="row no-print invoice">
                    <h4  class="purchase-heading" > <i class="fa fa-check-circle"></i> 
                      Entri Bayar Pembelian 
                    </h4>
                    <div class="col-md-12 ">
                        <div class="form-group">
                            <?php echo form_label('No Invoice'); ?>
                             <?php
                                $data = array('class'=>'form-control input-lg','type'=>'text','name'=>'description','reqiured'=>'', 'value'=>$no_invoice ,'readonly');
            ...
            <div class="row invoice">
                ...
                <div>
                    <tr>
                        <th>
                            <tr>
                                1. jangan rubah no invoice
                            </tr><br
                        </th>
                        <th>
                            <tr>
                                2. Pilih Hutang usaha Ap lalu pilih COA yang akan digunakan untuk membayar
                            </tr>
                        </th>
                    </tr>
                </div>
