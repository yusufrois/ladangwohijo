    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <a href="<?php echo base_url('expense/generate_pupuk'); ?>"  class="btn btn-danger btn-outline-primary"><i class="fa fa-plus-square" aria-hidden="true"></i>
                    <?php echo $page_add_button_report_pupuk; ?>
                </a>
...
<section class="content">
        ...
        <div class="col-xs-12 col-md-12 col-sm-12">
            <div class="box " id="print-section">
                ...
                <div class="box-body">
                    ...
                    ?>
                        <?php echo form_open('expense/generate_penjualan',$attributes); ?>
                            ...
                            <tbody>
                                <?php
                                        ...
                                        if($expense_record_list != NULL)
                                        {
                                            ...
                                            $modal = $total_pupuk + $total_air+$total_bbm+$total_listrik+$total_benih+$total_polinasi+$total_pegawai+$total_dasar+$total_kocor+$total_spray+$total_peralatan;
                                            foreach ($expense_record_list as $single_expense)
                                            {
                                                 $total_pupuk = $total_pupuk + $single_expense->tonase;
                                                 $total_paid =  $total_paid + $single_expense->harga;
                                    ...
                                    <tr>
                                            ...
                                            <td>
                                                <?php echo $single_expense->grade; ?>
                                            </td>
                                            <td>
                                                <?php echo number_format($single_expense->satuan,'0',',','.'); ?>
                                            </td>
                                            
                                            <td>
                                                <?php echo $single_expense->tonase; ?>
                                            </td>
                                            <td>
                                                <?php echo number_format($single_expense->harga,'0',',','.'); ?>
                                            </td>
                                            <td>
                                                <?php echo $single_expense->pembeli; ?>
                                            </td>
                                            <td>
    ...
    <div class="row bg-setting-product">
        <div class="col-md-12">
            <p><b> Total <?php echo $total_pupuk; ?> Kg,
               <b> Total Penjualan (<?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?>): </b> <?php echo number_format($total_paid,'0',',','.'); ?> /- dengan Keuntungan Rp. <b><?php echo number_format($total_penjualan - $modal,'0',',','.'); ?></b>
            </p>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">:</div>
                        <div class="col-md-3">Rp. <?php echo number_format(($modal / $total_benih_tanam),'0',',','.'); ?>/-</div>
                    </div>
                    <div class="row">
                    ...
                    <div class="row">
                        <div class="col-md-3">HPP JUAL</div>
                        <div class="col-md-1">:</div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-1">:</div>
                        <div class="col-md-3">Rp. <?php echo number_format(($total_penjualan / $total_benih_tanam) - ($modal / $total_benih_tanam),'0',',','.'); ?>/-</div>
                    </div>
                    <div class="row">
                        <div class="col-md-3">TONASE A</div>
                        <div class="col-md-1">:</div>
                        <div class="col-md-3">Kg. <?php echo $total_a; ?></div>
                    </div><div class="row">
                        <div class="col-md-3">TONASE B</div>
                        <div class="col-md-1">:</div>
                        <div class="col-md-3">Kg. <?php echo $total_b; ?></div>
                    </div><div class="row">
                        <div class="col-md-3">TONASE C</div>
                        <div class="col-md-1">:</div>
                        <div class="col-md-3">Kg. <?php echo $total_c; ?></div>
                    </div><div class="row">
                        <div class="col-md-3">TONASE RIJECT</div>
                        <div class="col-md-1">:</div>
                        <div class="col-md-3">Kg. <?php echo $total_r; ?></div>
                    </div>
                </div>
             </div>
         </div>
