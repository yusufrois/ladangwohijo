    ...
    <div class="row">
        <div class="col-md-12">
            <div class="pull pull-right">
                <button class="btn btn-info btn-outline-primary" onclick="show_modal_page('<?php echo base_url().'initilization/popup/add_brand_sector/'; ?>')" ><i class="fa fa-plus-square" aria-hidden="true"></i> Buat Sektor Merk
                </button>
                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li><a onclick="confirmation_alert('delete this  ','<?php echo base_url().'initilization/delete/brandSector/'.$single_brand->id; ?>')" href="javascript:void(0)" > <i class="fa fa-trash-o"></i> Hapus</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </td>
