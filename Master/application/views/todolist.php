                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="btn-group pull pull-right">
                                                ...
                                                <li><a onclick="confirmation_alert('delete this','<?php echo base_url(); ?>todolist/delete/<?php echo $obj_todo_records->id; ?>')"  href="javascript:void(0)" ><i class="fa fa-trash-o"></i> Hapus </a></li>
                                                <li>
                                                <?php
                        							if($obj_todo_records->status == 0)
                                                    {
                        						?>
                                                    <a onclick="confirmation_alert('make this in active ','<?php echo base_url(); ?>todolist/change_status/<?php echo $obj_todo_records->id; ?>/1')"  href="javascript:void(0)"   ><i class="fa fa-minus"></i> Nonaktifkan</a>
                                                    <?php
                        							}
                                                    else
                                                    {
                        						    ?>
                                                    <a onclick="confirmation_alert('make this active','<?php echo base_url(); ?>todolist/change_status/<?php echo $obj_todo_records->id; ?>/0')"  href="javascript:void(0)"  ><i class="fa fa-plus"></i> Aktifkan</a>
                                                    <?php
                        							     }
                        							?>
                                                </li>
