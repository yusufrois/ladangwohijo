                        ...
                        <tbody>
                            <?php
                                ...
                                <tr>
                                    ...
                                    <td><input type="date" class="supply_fields" name="tgl_exp" id="tgl_exp" value="<?php echo $single_item->expire; ?>">
                                    ...
                                    <td>
                                        <?php echo number_format($single_item->jumlah*$single_item->retail,'0',',','.'); ?>
                                    </td>
                                    <td>
                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                 <li >
                                                    <a onclick="confirmation_alert('update back this to stock  ','<?php echo base_url();?>product/update_return/<?php echo $single_item->id.'/'; ?>'+ $('#jml_return').val()+'/'+ $('#tgl_exp').val())"  href="javascript:void(0)" > 
                                                        <i class="fa fa-pencil"> </i> Update kembali ke stok
                                                    </a>
                                                </li>
                                                <li >
                                                    <a onclick="confirmation_alert('Silahkan input jurnal di menu pembelian  ','<?php echo base_url();?>product/update_delete_return/<?php echo $single_item->id.'/'; ?>'+ $('#jml_return').val())"  href="javascript:void(0)" > 
                                                        <i class="fa fa-pencil"> </i> Hapus / Ganti Uang
                                                    </a>
                                                </li>
                                            </ul>
                                        </div>
