                                        ...
                                        <td>
                                            <div class="btn-group no-print pull pull-right">
                                                ...
                                                <ul class="dropdown-menu " role="menu">
                                                    <li>
                                                        <a onclick="confirmation_alert('update this to stock  ','<?php echo base_url().'product/update_to_stock/'.$single_list->id; ?>')"  href="javascript:void(0)"><i class="fa  fa-arrow-circle-o-right"></i> Update ke stok
                                                        </a>
                                                    </li> 
                                                    ...
                                                    <li  >      
                                                        <a onclick="confirmation_alert('delete this ','<?php echo base_url().'product/delete_stock/'.$single_list->id; ?>')"  href="javascript:void(0)" >       <i class="fa fa-trash"></i>   Hapus
                                                        </a>
                                                    </li>
                                                </ul>
                                            </div>
