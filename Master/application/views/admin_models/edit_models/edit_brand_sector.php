		...
		<div class="box box-danger">
			<div class="box-body">	
				<div class="col-md-12">
					...
					<div class="form-group">
						<?php
							$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_medicine','value'=>'true', 'content' => '<i class="fa fa-pencil" aria-hidden="true"></i> Perbatui Sektor Merk');
