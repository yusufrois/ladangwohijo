	  	...
	  	<div class="box box-danger">
		    <div class="box-body">
				...
				<?php echo form_open('bank/edit/',$Edit_attributes); ?>	  
			      ...
			      <div class="form-group">    
					<?php
							echo form_label('Nama Pemilik Rekening:');
			      ...
			      <div class="form-group">    
					<?php
							echo form_label('Nomor Rekening:');
				  ...
				  <div class="form-group">  				
			         <?php
						$data = array('class'=>'btn btn-info btn-outline-primary ','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Perbarui Bank ');
