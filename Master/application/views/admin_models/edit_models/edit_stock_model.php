...
<div class="modal-header">
	...
	<h4 class="modal-title"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit Rincian Stok</h4>
</div>
		...
		<div class="box box-danger">
			<div class="box-body">
				...
				<div id="print-section-model" class="col-md-12">
					...
					<div class="form-group">
						<?php
							$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_stock','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Perbarui Stok');
