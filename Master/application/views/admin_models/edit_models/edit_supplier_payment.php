          ...
          <div class="col-md-12">
			...
			<?php echo form_open('supplier/edit_supplier_payments',$attributes); ?>  
				<div class="form-group">
				  ...
				  <div class="form-group">  				
					<?php
						$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_category','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Perbarui Pembayaran');
