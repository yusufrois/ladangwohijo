          ...
          <div class="box box-danger">
			...
			<?php echo form_open('todolist/edit/',$Edit_attributes); ?> 			  
              <div class="form-group">    
				<?php
						echo form_label('Permintaan item:');
			  ...
			  <div class="form-group">  				
                 <?php
					$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_todo_list','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Perbarui Permintaan');
