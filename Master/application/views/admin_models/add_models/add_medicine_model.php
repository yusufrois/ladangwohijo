...
<div class="modal-header">
	...
	<h4 class="modal-title"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Produk
	</h4>
</div>
			...
			<div class="box-body">	
				<div class="col-md-12">
					...
					<div class="form-group">
						<label>Kategori: <a onclick="show_modal_page('<?php echo base_url();?>category/popup/add_category_model')" href="#"> (Tambah kategori)</a></label>				
