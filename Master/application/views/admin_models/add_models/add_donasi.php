			...
			<div class="box-body">	
				<div class="col-md-12">
					...
					<div class="form-group">
						...
						<?php			
								$data = array('class'=>'form-control input-lg','type'=>'number','name'=>'name','placeholder'=>'0','reqiured'=>'');
					...
					<div class="form-group">
						...
						<?php			
								$data = array('class'=>'form-control input-lg','type'=>'text','name'=>'keterangan','placeholder'=>'Keterangan','reqiured'=>'');
								echo form_input($data);			
						?>
					</div>
					<div class="form-group">
						<?php
							$data = array('class'=>'btn btn-info btn-outline-primary','type' => 'submit','name'=>'btn_submit_medicine','value'=>'true', 'content' => '<i class="fa fa-floppy-o" aria-hidden="true"></i> Kirim Donasi ');
