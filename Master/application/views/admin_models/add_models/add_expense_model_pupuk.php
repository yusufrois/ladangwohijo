...
<div class="modal-header">
	...
	<h4 class="modal-title"><i class="fa fa-plus-square" aria-hidden="true"></i> Tambah Expense Pupuk
	</h4>
</div>
<div class="modal-body">
		...
		<div class="box box-danger">
			<div class="box-body">	
				<div class="col-md-12">
					...
					?>
					<?php echo form_open('expense/add_pupuk',$attributes); ?>				
	...
	<!-- <div class="form-group">
		<?php echo form_label('Harga Satuan:'); ?>(<?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?>)
		<?php			
		$data = array('class'=>'form-control input-lg','type'=>'number','name'=>'bill_satuan','placeholder'=>'e.g 250','reqiured'=>'');
		echo form_input($data);			
		?>
	</div> -->
	<div class="form-group">
               	...
               	<?php
					$data = array('class'=>'form-control input-lg','type'=>'number','name'=>'bill_satuan','id'=>'bill_satuan','placeholder'=>'e.g 10');
					echo form_input($data);
			  	?>
                </div>
	<div class="form-group">
               ...
               <?php
					$data = array('class'=>'form-control input-lg','type'=>'number','id'=>'bill_jumlah','name'=>'bill_jumlah','placeholder'=>'e.g 10','reqiured'=>'', 'readonly');
					echo form_input($data);
			  ?>
                </div>
	<!-- <div class="form-group">
		<?php echo form_label('Jumlah:'); ?>(<?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?>)
		<?php			
		$data = array('class'=>'form-control input-lg','type'=>'number','step'=>'.01','name'=>'bill_jumlah','placeholder'=>'e.g 250','reqiured'=>'');
		echo form_input($data);			
		?>
	</div> -->
	<div class="form-group">
			   <?php echo form_label('Total Tagihan:'); ?>
               <?php
					$data = array('class'=>'form-control input-lg','type'=>'number','id'=>'bill_total','name'=>'bill_total','placeholder'=>'e.g 10','reqiured'=>'', 'readonly');
					echo form_input($data);
			  ?>
                </div>
	<!-- <div class="form-group">
		...
		<?php			
		$data = array('class'=>'form-control input-lg','type'=>'number','step'=>'.01','name'=>'bill_total','placeholder'=>'e.g 250','reqiured'=>'');
		echo form_input($data);			
		?>
	</div> -->
	<!-- <div class="form-group">
	...
	<div class="form-group">
		...
		<?php				
		$data = array('class'=>'form-control input-lg','type'=>'text','id'=>'toko','name'=>'toko','placeholder'=>'e.g Nama Toko','reqiured'=>'');
		echo form_input($data);			
		?>
	</div>
	<div class="form-group">
...
$(function(){
    ...
    $('#bill_satuan').keyup(function(value){
    	//var packs = $('#jumlah_sistem').val();
    	var packsize = $('#bill_satuan').val();
    	var jml = $('#bill_jumlah').val();
    	//var jual = $('#jual').val();
    	
    	$('#bill_total').val(jml*packsize);
    	//$('#hutang').val((packs-packsize)* jual);
    });

    $('#bill_jumlah').keyup(function(value){
    	//var packs = $('#jumlah_sistem').val();
    	var packsize = $('#bill_satuan').val();
    	var jml = $('#bill_jumlah').val();
    	//var jual = $('#jual').val();
