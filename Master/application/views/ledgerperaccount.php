...
<section class="content">
    <div class="box" id="print-section">
        <div class="box-body box-bg ">
            ...
            ?>
            <?php echo form_open_multipart('statements/leadgerPerAccounst',$attributes); ?>
            <div class="row no-print">
                
                <div class="col-md-3">
                    <div class="form-group">
                            <?php echo form_label('Pilih Tahun'); ?>
                              <select name="year" class="form-control select2 input-lg">
                                    <?php 
                                      foreach ($tahun as $single_head) {
                                    ?>
                                         <option value="<?php echo $single_head->tgl ?>">
                                          <?php echo $single_head->tgl ?>
                                          </option>
                                    <?php   
                                      }
                                    ?>   
        ...
        <div class="row">
            <div class="col-md-3"></div>
                <div class="col-md-6">
                   ...
                   <h4 style="text-align:center"><b> Dari </b> <?php echo $year; ?> <b> Sampai </b> <?php echo $year; ?></h4>
