...
<div class="wrapper">
  ...
  <?php
   if(uri_string() != 'invoice' AND uri_string() != 'invoice_2' AND uri_string() != 'invoice/add_auto_invoice' AND uri_string() != 'invoice_2/add_auto_invoice' AND uri_string() != 'struk' AND uri_string() != 'return_items')
  {
  ?>
   <!-- Header  -->
