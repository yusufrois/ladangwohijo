...
<section class="content">
        ...
        <div class="col-xs-12 col-md-12 col-sm-12">
            <div class="box " id="print-section">
                <div class="box-header">
                    <h3 class="box-title"><i class="fa fa-arrow-circle-right" aria-hidden="true"></i> Daftar Ketersediaan Stok</h3>
                </div>
                <div class="box-body">
                            ...
                            <tbody>
                                <?php
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <?php 
                                                $result = fetch_single_return_productlist($single_item->id);
                                                echo ($result != NULL ? $result  : '0');
                                              ?>
                                        </td>
                                        <td>
    ...
    <div class="row bg-setting-product">
        <div class="col-md-12">
            <p><b> Total item dalam stok (<?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?>)</b>  <?php echo $total_stock; ?> dengan
               <b> kekayaan bersih (<?php echo $this->db->get_where('mp_langingpage', array('id' => 1))->result_array()[0]['currency'] ;?>): </b> <?php echo $total_worth; ?> /-
