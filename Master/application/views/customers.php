                                    ...
                                    <td>
                                        <div class="btn-group pull no-print pull-right">
                                            ...
                                            <ul class="dropdown-menu" role="menu">
                                                ...
                                                <li onclick="show_modal_page('<?php echo base_url().'customers/popup/edit_customer_model/'.$obj_customer_list->id; ?>')" ><a href="#"><i class="fa fa-pencil"></i> Lihat</a></li>
                                                <li>
                                                    <a onclick="confirmation_alert('delete this  ','<?php echo base_url().'customers/delete/'.$obj_customer_list->id; ?>')"  href="javascript:void(0)" ><i class="fa fa-trash-o"></i> Hapus
                                                    </a>
                                                </li>  
                                                <?php
                                                if($obj_customer_list->cus_status != 0)
                                                ...
                                                ?>
                                                    <li>
                                                        <a onclick="confirmation_alert('make this active','<?php echo base_url(); ?>customers/change_status/<?php echo $obj_customer_list->id; ?>/0')"  href="javascript:void(0)"  ><i class="fa fa-minus"></i> Aktif</a>
                                                    </li>
                                                    <?php
                                                    }
                                                    ...
                                                    ?>
                                                        <li>
                                                            <a onclick="confirmation_alert('make this in active','<?php echo base_url(); ?>customers/change_status/<?php echo $obj_customer_list->id; ?>/1')"  href="javascript:void(0)" ><i class="fa fa-minus"></i> Tidak Aktif</a>
                                                        </li>
                                                    <?php
                                                    }
                                                    ?>  
