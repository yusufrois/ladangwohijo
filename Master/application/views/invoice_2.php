<section class="invoice">
    ...
    ?>
    <?php echo form_open('invoice_2/add_auto_invoice',$attributes); ?>
    <!-- title row -->
    ...
    <div class="row">
        ...
        <div class="col-md-9">
           <!--  <div class="pull-right ">
            ...
            <div class="pull-right ">
                <a class="pull-right btn-flat pos-invoice-btn  homescreen-icon btn btn-primary" href="<?php echo base_url('invoice'); ?>">   <i class="fa fa-dashboard"></i>    Home screen
                </a>
            </div>                
            <!-- <div class="pull-right ">
        ...
        <div id="inner_invoice_area" class="col-md-12 ">
         ...
         <p class="col-md-12">
            <small class="instructions ">
             <b>ESC</b> Invoice Baru2 | <b>F4</b>Retur item | <b>Insert</b> Simpan invoice | <b>F2</b> Lihat invoice
            </small>
        </p>   
