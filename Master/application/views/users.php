                                        ...
                                        <td>
                                            <div class="btn-group no-print pull pull-right">
                                                ...
                                                <ul class="dropdown-menu" role="menu">
                                                    <li  onclick="show_modal_page('<?php echo base_url().'users/popup/edit_user_model/'.$obj_user_list->id ?>')"><a href="#"><i class="fa fa-pencil"></i> Lihat</a></li>
                                                    <li><a onclick="confirmation_alert('delete this  ','<?php echo base_url().'users/delete/'.$obj_user_list->id; ?>')"  href="javascript:void(0)" ><i class="fa fa-trash-o"></i> Hapus</a></li>
                                                    <li>
                                                        <?php
                                                             if($obj_user_list->status == 0)
                                                             {
                                                        ?>
                                                            <a onclick="confirmation_alert('make this in active  ','<?php echo base_url(); ?>index.php/Users/change_status/<?php echo $obj_user_list->id; ?>/1')"  href="javascript:void(0)" >
                                                                <i class="fa fa-minus"></i> Nonaktifkan</a>
                                                            <?php
                                                                }
                                                                else
                                                                {
                                                             ?>
                                                            <a onclick="confirmation_alert('make this active  ','<?php echo base_url(); ?>index.php/Users/change_status/<?php echo $obj_user_list->id; ?>/0')"  href="javascript:void(0)"  ><i class="fa fa-plus"></i> Aktifkan</a>
                                                            <?php
                                                             }
                                                            ?>
                                                    </li>
