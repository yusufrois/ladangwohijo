...
class Supplier extends CI_Controller
{
	...
	public function index()
	{
		...
		$data['table_name'] = 'DAFTAR SUPPLIER :';
 ...
 function upload_csv()
	...
	{
		// DEFINES PAGE TITLE
		$data['title'] = 'Pembayaran Supplier';

		// DEFINES NAME OF TABLE HEADING
		$data['table_name'] = 'PEMBAYARAN SUPPLIER:';
	...
	{
		// DEFINES PAGE TITLE
		$data['title'] = 'Buku Besar Supplier';

		// DEFINES NAME OF TABLE HEADING
		$data['table_name'] = 'BUKU BESAR SUPPLIER :';
