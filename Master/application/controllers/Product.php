...
public function update_return($id, $jumlah,$tgl){
  $result = $this->Crud_model->kurang_retur($id,$jumlah,$tgl);
  if ($result == 1)
  {
   $array_msg = array(
    'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Status changed Successfully!',
...
public function update_delete_return($id, $jumlah){
  $user_name = $this->session->userdata('user_id');
  $result = $this->Crud_model->gagal_return($id,$jumlah,$user_name['id']);
  if ($result == 1)
  {
   $array_msg = array(
    'msg' => '<i style="color:#fff" class="fa fa-check-circle-o" aria-hidden="true"></i> Status changed Successfully!',
