...
class Accounts_model extends CI_Model
{
    ...
    {
        $this->db->select('mp_purchase.id,mp_purchase.total_amount,mp_purchase.cash,mp_head.name as nama,mp_purchase.description,mp_purchase.payment_date,mp_payee.customer_name,mp_payee.cus_email,mp_payee.cus_contact_1');
        $this->db->from('mp_purchase');

        $this->db->join('mp_head', "mp_head.id = mp_purchase.payment_type_id");
    ...
    function fetch_single_return_productlist($return_id)
    {

         $this->db->select('Jumlah');
        $this->db->from('mp_productslist_resturn');
         $this->db->where('id_produk',$return_id);
