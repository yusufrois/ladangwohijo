...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 04, 2022 at 02:49 PM
...
(19, 'rois', 'yusuf@kantorku.com', '', 'sdiaoarjo', '0', '081222222', 'perusahaan', 'ket', 'default.jpg', 0, 'region', 'kota', 'Karyawan	', '', '2022-08-04', '0', 'karyawan'),
(20, 'yusuf', 'email@gmail.com', '', 'alamat', '098', '098', 'perusahaan', 'keteranagn', 'default.jpg', 0, 'region', 'kota', 'Karyawan	', '', '2022-08-04', '789', 'employee'),
(21, 'alfinf', 'alfin@gmail.com', '', 'jl saja', '92349032', '099999999', 'indraco', 'coba employee', 'default.jpg', 0, 'jawa barat', 'malang', 'Regular', '', '2022-08-04', '323454353', 'employee');
...
(1375, 4, 'NEO RHEUMACYL 20 TABLET', '1', 16, '3400.00', '4000.00', '2025-06-10', '2019-07-09', 'No Effects', 'here', '8999908000101', 10, 0, 0, '1', '', 'Ware House', '0.00', 'Finished Products', 'cf7dfe436d8da53ed901cd0077f037ed.jpg', 1, 2, 'Pcs', '', '3900.00'),
...
('3b0b1esrml0jhh42o80jt21d6ig3k2uc', '::1', 1659623142, ),
...
('d61q6ee16o0v92f01d0imjbgrsj6vimq', '::1', 1659624491, 0x5f5f63695f6c6173745f726567656e65726174657c693a313635393632343330393b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
...
('fhmgt37m34o7stbk12pg4s6qqv7peno3', '::1', 1659622838, 0x5f5f63695f6c6173745f726567656e65726174657c693a313635393632323833383b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
...
('l8ke6sc4vj67c5mmnhr3tn0h64auq66q', '::1', 1659624309, 0x5f5f63695f6c6173745f726567656e65726174657c693a313635393632343330393b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
...
('svk2qv3qhuqlmtp4i2rbauqrl2s0i0bi', '::1', 1659623443, 0x5f5f63695f6c6173745f726567656e65726174657c693a313635393632333434333b757365725f69647c613a323a7b733a323a226964223b733a313a2231223b733a343a226e616d65223b733a31323a225375707065722041646d696e223b7d),
...
CREATE TABLE IF NOT EXISTS `mp_temp_barcoder_purchase` (
`id` int(11) NOT NULL,
  `barcode` varchar(255) CHARACTER SET latin1 NOT NULL,
  `product_no` varchar(255) CHARACTER SET latin1 NOT NULL,
  `product_id` int(11) NOT NULL,
...
(8, '8999908000101', '', 1375, 'NEO RHEUMACYL 20 TABLET', '1', '4000.00', '3400.00', 4, 0.00, 1, 'pos', 0),
...
ALTER TABLE `mp_bank_transaction`
 ADD PRIMARY KEY (`id`), ADD KEY `transaction_id` (`transaction_id`), ADD KEY `bank_id` (`bank_id`), ADD KEY `payee_id` (`payee_id`);
...
ALTER TABLE `mp_customer_payments`
 ADD PRIMARY KEY (`id`), ADD KEY `transaction_id` (`transaction_id`), ADD KEY `customer_id` (`customer_id`);
...
ALTER TABLE `mp_expense`
 ADD PRIMARY KEY (`id`), ADD KEY `head_id` (`head_id`), ADD KEY `transaction_id` (`transaction_id`), ADD KEY `payee_id` (`payee_id`);
...
ALTER TABLE `mp_invoices`
 ADD PRIMARY KEY (`id`), ADD KEY `id` (`id`), ADD KEY `cus_id` (`cus_id`), ADD KEY `prescription_id` (`prescription_id`), ADD KEY `transaction_id` (`transaction_id`);
...
ALTER TABLE `mp_multipleroles`
 ADD PRIMARY KEY (`id`), ADD KEY `user_id` (`user_id`), ADD KEY `menu_Id` (`menu_Id`), ADD KEY `agentid` (`agentid`);
...
ALTER TABLE `mp_productslist`
 ADD PRIMARY KEY (`id`), ADD KEY `category_id` (`category_id`), ADD KEY `brand_id` (`brand_id`), ADD KEY `brand_sector_id` (`brand_sector_id`), ADD KEY `unit_type` (`unit_type`);

--
-- Indexes for table `mp_purchase`
--
ALTER TABLE `mp_purchase`
 ADD PRIMARY KEY (`id`), ADD KEY `transaction_id` (`transaction_id`), ADD KEY `supplier_id` (`supplier_id`);
...
ALTER TABLE `mp_return`
 ADD PRIMARY KEY (`id`), ADD KEY `transaction_id` (`transaction_id`), ADD KEY `cus_id` (`cus_id`), ADD KEY `invoice_id` (`invoice_id`);

--
-- Indexes for table `mp_return_list`
--
ALTER TABLE `mp_return_list`
 ADD PRIMARY KEY (`id`), ADD KEY `transaction_id` (`return_id`), ADD KEY `medicine_id` (`product_id`);

--
-- Indexes for table `mp_sales`
--
ALTER TABLE `mp_sales`
 ADD PRIMARY KEY (`id`), ADD KEY `medicine_id` (`product_id`), ADD KEY `order_id` (`order_id`);
...
ALTER TABLE `mp_sub_entry`
 ADD PRIMARY KEY (`id`), ADD KEY `sid` (`parent_id`), ADD KEY `accounthead` (`accounthead`), ADD KEY `amount` (`amount`);
...
ALTER TABLE `mp_supply`
 ADD PRIMARY KEY (`id`), ADD KEY `driver_id` (`driver_id`), ADD KEY `vehicle_id` (`vehicle_id`), ADD KEY `region_id` (`region_id`), ADD KEY `town_id` (`town_id`);

--
-- Indexes for table `mp_temp_barcoder_invoice`
--
ALTER TABLE `mp_temp_barcoder_invoice`
 ADD PRIMARY KEY (`id`), ADD KEY `product_id` (`product_id`), ADD KEY `agentid` (`agentid`);
...
ALTER TABLE `mp_units`
 ADD PRIMARY KEY (`id`), ADD KEY `symbol` (`symbol`);

--
-- Indexes for table `mp_users`
--
ALTER TABLE `mp_users`
 ADD PRIMARY KEY (`id`), ADD KEY `user_name` (`user_name`), ADD KEY `user_name_2` (`user_name`);
